                ...
                return (
                  <WrapperItemOrder key={order?.product}>
                    ...
                    <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                      ...
                      <p style={{ cursor: 'pointer', color: 'Red', fontSize: '15px' }} onClick={() => handleDeleteOrder(order?.product)}>Xóa</p>
                    </div>
                  </WrapperItemOrder>
                )
              })}
          ...
          <WrapperRight>
            <div style={{ width: '100%' }}>
              <WrapperInfo>
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                  <span style={{ fontSize: '15px' }}>Phí giao hàng (10k)</span>
              ...
              <WrapperTotal>
                ...
                <span style={{ display: 'flex', flexDirection: 'column' }}>
                  <span style={{ color: 'red', fontSize: '24px', fontWeight: 'bold' }}>{convertPrice(totalPriceMemo)}</span>
                </span>
              </WrapperTotal>
            </div>
            <ButtonComponent
